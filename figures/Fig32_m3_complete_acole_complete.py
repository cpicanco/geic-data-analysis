...
def plot():
    ...
    """
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=False, filename='Fig32_m3_completo_acoles_completas')
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=True, filename='Fig32_m3_completo_acoles_completas')
