...
from Fig27b import plot_blocks_pairs
...
def bar_plot(ACOLE1, MODULE3, ACOLE2, use_boxplot, filename):
...
def plot():
    ...
    bar_plot(ACOLE_1, MODULE_3, ACOLE_2, use_boxplot=False, filename='Fig29b')
    bar_plot(ACOLE_1, MODULE_3, ACOLE_2, use_boxplot=True, filename='Fig29b')
