...
def plot():
    ...
    """
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=False, filename='Fig34_has_first_acole_incomplete')
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=True, filename='Fig34_has_first_acole_incomplete')
