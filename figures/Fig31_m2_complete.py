...
def plot():
    ...
    """
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=False, filename='Fig31_m2_completo_acoles_completas_ou_incompletas')
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=True, filename='Fig31_m2_completo_acoles_completas_ou_incompletas')
