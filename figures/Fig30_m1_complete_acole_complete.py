...
def plot():
    ...
    """
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=False, filename='Fig30_m1_completo_acoles_completas')
    bar_plot(ACOLE_1, ACOLE_2, use_boxplot=True, filename='Fig30_m1_completo_acoles_completas')
